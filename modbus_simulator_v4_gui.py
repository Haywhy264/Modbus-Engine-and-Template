#!/usr/bin/env python3
"""Simple GUI launcher for the Modbus simulator v4 (50 dummy sensor tags)."""
...
def _build_register_rows() -> list[tuple[str, str, str, str, str, str, str]]:
...
REGISTER_ROWS = _build_register_rows()


class SimulatorGUI(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("Modbus Sensor Simulator V4")
        ...
        self._script_path = Path(__file__).with_name("modbus_meter_simulator_v4.py")
    ...
    def _build_ui(self) -> None:
        ...
        self.port_var = tk.StringVar(value="5022")
        ...
        ttk.Label(clients, textvariable=self.local_ips_var, wraplength=1010).pack(anchor=tk.W, pady=(0, 2))
        ttk.Label(
            clients,
        ...
        register_panel = ttk.LabelFrame(self, text="Register Map (50 tags)", padding=(10, 6, 10, 8))
        register_panel.pack(fill=tk.BOTH, padx=10, pady=(0, 8), expand=False)
