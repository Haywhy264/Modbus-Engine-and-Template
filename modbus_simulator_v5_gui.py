#!/usr/bin/env python3
"""Simple GUI launcher for the Modbus simulator v5 (500 dummy sensor tags)."""
...
class SimulatorGUI(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("Modbus Sensor Simulator V5")
        ...
        self._script_path = Path(__file__).with_name("modbus_meter_simulator_v5.py")
    ...
    def _build_ui(self) -> None:
        ...
        register_panel = ttk.LabelFrame(self, text="Register Map (500 tags)", padding=(10, 6, 10, 8))
